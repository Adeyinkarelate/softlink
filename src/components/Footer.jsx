...
const Footer = () => {
  return (
    <div>
      <footer>
        <div className="mx-auto border px-4 py-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-5 text-center md:grid-cols-3">
            <div>
              <a
                className="flex-none text-xl font-semibold text-emerald-700"
                href="#"
                aria-label="Brand"
              >
                Dev-connect
            ...
            <ul className="text-center">
              <li className="relative inline-block pr-8 before:absolute before:right-3 before:top-1/2 before:-translate-y-1/2 before:text-gray-300 before:content-['/'] last:pr-0 last-of-type:before:hidden dark:before:text-gray-600">
                <Link
                  className="group inline-flex items-center gap-x-2 text-sm font-medium text-gray-500 hover:text-gray-800"
                  to="/wallet"
                >
                  Connect Wallet
                  <svg
